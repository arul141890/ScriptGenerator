...
{
    public partial class Dnsrecordcreations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(DnsrecordcreationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Dnsrecordcreation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Dns/AddDnsrecordcreation.aspx?vscId={0}";
