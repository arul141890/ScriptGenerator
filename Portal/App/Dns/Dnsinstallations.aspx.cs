...
{
    public partial class Dnsinstallations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(DnsinstallationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Dnsinstallation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Dns/AddDnsinstallation.aspx?vscId={0}";

            this.gvData.GenerateColumns();

            this.pnlFilter.IgnoreFields = "Id,Staticip";
