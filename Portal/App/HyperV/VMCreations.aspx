<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="VMCreations.aspx.cs" Inherits="Portal.App.HyperV.VMCreations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/HyperV/AddVMCreation.aspx") %>">Create New Virtual Machine </a>
            </li>
        </ul>
    </div>
    <div>
