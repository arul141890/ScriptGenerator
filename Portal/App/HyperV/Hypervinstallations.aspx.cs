...
{
    public partial class Hypervinstallations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(HypervinstallationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Hypervinstallation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/HyperV/AddHypervinstallation.aspx?vscId={0}";

            this.gvData.GenerateColumns();

            this.pnlFilter.IgnoreFields = "Id,Isphysicalmachine,Isvtenabled";
