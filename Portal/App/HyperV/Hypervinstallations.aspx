<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="Hypervinstallations.aspx.cs" Inherits="Portal.App.HyperV.Hypervinstallations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/HyperV/AddHypervinstallation.aspx") %>">Install Hyper-V Server</a>
            </li>
        </ul>
    </div>
    <div>
