<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="VirtualSwitchCreations.aspx.cs" Inherits="Portal.App.HyperV.VirtualSwitchCreations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="s-gridview-container">
            <asp:GridViewEx runat="server" ID="gvData" DataSourceID="dsData" OnDataBound="gvData_DataBound" />
        </div>
