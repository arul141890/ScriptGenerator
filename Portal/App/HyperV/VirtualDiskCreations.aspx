<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="VirtualDiskCreations.aspx.cs" Inherits="Portal.App.HyperV.VirtualDiskCreations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/HyperV/AddVirtualDiskCreation.aspx") %>">Add new Virtual Disk</a>
            </li>
        </ul>
    </div>
    <div>
