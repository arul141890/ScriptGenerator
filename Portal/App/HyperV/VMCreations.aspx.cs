...
{
    public partial class VMCreations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(VMCreationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(VMCreation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/HyperV/AddVMCreation.aspx?vscId={0}";
