<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="Collectioncreations.aspx.cs" Inherits="Portal.App.Remotedesktopservices.Collectioncreations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/Remotedesktopservices/AddCollectioncreation.aspx") %>">Create New Collections</a>
            </li>
        </ul>
    </div>
    <div>
