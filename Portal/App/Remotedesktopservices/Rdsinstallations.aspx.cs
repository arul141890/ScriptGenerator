...
{
    public partial class Rdsinstallations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(RdsinstallationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Rdsinstallation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Remotedesktopservices/AddRdsinstallation.aspx?vscId={0}";
