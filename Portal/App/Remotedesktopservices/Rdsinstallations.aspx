<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="Rdsinstallations.aspx.cs" Inherits="Portal.App.Remotedesktopservices.Rdsinstallations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/Remotedesktopservices/AddRdsinstallation.aspx") %>">Install RDS Role servers</a>
            </li>
        </ul>
    </div>
    <div>
