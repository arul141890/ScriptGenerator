...
{
    public partial class Apppublishs : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(ApppublishDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Apppublish).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Remotedesktopservices/AddApppublish.aspx?vscId={0}";

            this.gvData.GenerateColumns();

            this.pnlFilter.IgnoreFields = "Id,Filepath";
