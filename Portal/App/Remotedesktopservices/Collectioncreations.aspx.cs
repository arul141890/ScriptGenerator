...
{
    public partial class Collectioncreations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(CollectioncreationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Collectioncreation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Remotedesktopservices/AddCollectioncreation.aspx?vscId={0}";

            this.gvData.GenerateColumns();

            this.pnlFilter.IgnoreFields = "Id,Collectiondescription";
