<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="Webserverinstallations.aspx.cs" Inherits="Portal.App.Webserver.Webserverinstallations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/Webserver/AddWebserverinstallation.aspx") %>">Install New WebServer</a>
            </li>
        </ul>
    </div>
    <div>
