...
{
    public partial class Websitecreations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(WebsitecreationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Websitecreation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Webserver/AddWebsitecreation.aspx?vscId={0}";
