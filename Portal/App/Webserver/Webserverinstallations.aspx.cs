...
{
    public partial class Webserverinstallations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(WebserverinstallationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Webserverinstallation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Webserver/AddWebserverinstallation.aspx?vscId={0}";
