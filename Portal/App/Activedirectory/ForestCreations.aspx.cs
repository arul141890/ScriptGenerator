...
{
    public partial class ForestCreations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(ForestCreationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Forestcreation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Activedirectory/AddForestCreation.aspx?vscId={0}";

            this.gvData.GenerateColumns();

            this.pnlFilter.IgnoreFields = "Id,Databasepath,Domainmode,Forestmode,Logpath,Sysvolpath";
