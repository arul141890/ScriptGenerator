<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="Addingdcs.aspx.cs" Inherits="Portal.App.Activedirectory.Addingdcs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/Activedirectory/AddAddingdc.aspx") %>">Add a New Domain Controller</a>
            </li>
        </ul>
    </div>
    <div>
