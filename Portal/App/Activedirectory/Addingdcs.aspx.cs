...
{
    public partial class Addingdcs : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(AddingdcDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Addingdc).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Activedirectory/AddAddingdc.aspx?vscId={0}";

            this.gvData.GenerateColumns();

            this.pnlFilter.IgnoreFields = "Id,Databasepath,Logpath,Sysvolpath";
