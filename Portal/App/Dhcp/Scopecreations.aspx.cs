...
{
    public partial class Scopecreations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(ScopecreationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Scopecreation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Dhcp/AddScopecreation.aspx?vscId={0}";
