...
{
    public class SmbsharecreationDataSource
    {
        public SmbsharecreationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Smbsharecreation> Service { get; set; }

        public virtual IEnumerable<Smbsharecreation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Smbsharecreation> queryable;

            IEnumerable<Smbsharecreation> logs;
        ...
        public virtual void Delete(Smbsharecreation entity)
        {
