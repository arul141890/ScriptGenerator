...
{
    public class VirtualSwitchCreationDataSource
    {
        public VirtualSwitchCreationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<VirtualSwitchCreation> Service { get; set; }

        public virtual IEnumerable<VirtualSwitchCreation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<VirtualSwitchCreation> queryable;

            IEnumerable<VirtualSwitchCreation> logs;
