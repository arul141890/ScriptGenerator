...
{
    public class VirtualDiskCreationDataSource
    {
        public VirtualDiskCreationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<VirtualDiskCreation> Service { get; set; }

        public virtual IEnumerable<VirtualDiskCreation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<VirtualDiskCreation> queryable;

            IEnumerable<VirtualDiskCreation> logs;
