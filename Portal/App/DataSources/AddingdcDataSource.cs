...
{
    public class AddingdcDataSource
    {
        public AddingdcDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Addingdc> Service { get; set; }

        public virtual IEnumerable<Addingdc> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Addingdc> queryable;

            IEnumerable<Addingdc> logs;
        ...
        public virtual void Delete(Addingdc entity)
        {
