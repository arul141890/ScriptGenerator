...
{
    public class ApppublishDataSource
    {
        public ApppublishDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Apppublish> Service { get; set; }

        public virtual IEnumerable<Apppublish> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Apppublish> queryable;

            IEnumerable<Apppublish> logs;
