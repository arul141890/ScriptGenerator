...
{
    public class RdsinstallationDataSource
    {
        public RdsinstallationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Rdsinstallation> Service { get; set; }

        public virtual IEnumerable<Rdsinstallation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Rdsinstallation> queryable;

            IEnumerable<Rdsinstallation> logs;
