...
{
    public class DnsrecordcreationDataSource
    {
        public DnsrecordcreationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Dnsrecordcreation> Service { get; set; }

        public virtual IEnumerable<Dnsrecordcreation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Dnsrecordcreation> queryable;

            IEnumerable<Dnsrecordcreation> logs;
        ...
        public virtual void Delete(Dnsrecordcreation entity)
        {
