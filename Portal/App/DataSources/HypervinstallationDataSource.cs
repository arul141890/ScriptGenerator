...
{
    public class HypervinstallationDataSource
    {
        public HypervinstallationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Hypervinstallation> Service { get; set; }

        public virtual IEnumerable<Hypervinstallation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Hypervinstallation> queryable;

            IEnumerable<Hypervinstallation> logs;
