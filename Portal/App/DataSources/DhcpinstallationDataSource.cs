...
{
    public class DhcpinstallationDataSource
    {
        public DhcpinstallationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Dhcpinstallation> Service { get; set; }

        public virtual IEnumerable<Dhcpinstallation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Dhcpinstallation> queryable;

            IEnumerable<Dhcpinstallation> logs;
