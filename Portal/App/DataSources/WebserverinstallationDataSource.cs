...
{
    public class WebserverinstallationDataSource
    {
        public WebserverinstallationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Webserverinstallation> Service { get; set; }

        public virtual IEnumerable<Webserverinstallation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Webserverinstallation> queryable;

            IEnumerable<Webserverinstallation> logs;
