...
{
    public class NamespacecreationDataSource
    {
        public NamespacecreationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Namespacecreation> Service { get; set; }

        public virtual IEnumerable<Namespacecreation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Namespacecreation> queryable;

            IEnumerable<Namespacecreation> logs;
        ...
        public virtual void Delete(Namespacecreation entity)
        {
