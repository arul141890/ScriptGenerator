...
{
    public class CollectioncreationDataSource
    {
        public CollectioncreationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Collectioncreation> Service { get; set; }

        public virtual IEnumerable<Collectioncreation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Collectioncreation> queryable;

            IEnumerable<Collectioncreation> logs;
