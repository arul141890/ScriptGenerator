...
{
    public class ScopecreationDataSource
    {
        public ScopecreationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Scopecreation> Service { get; set; }

        public virtual IEnumerable<Scopecreation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Scopecreation> queryable;

            IEnumerable<Scopecreation> logs;
