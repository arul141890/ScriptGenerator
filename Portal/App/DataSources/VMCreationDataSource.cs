...
{
    public class VMCreationDataSource
    {
        public VMCreationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<VMCreation> Service { get; set; }

        public virtual IEnumerable<VMCreation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<VMCreation> queryable;

            IEnumerable<VMCreation> logs;
