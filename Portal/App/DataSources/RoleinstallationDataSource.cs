...
{
    public class RoleinstallationDataSource
    {
        public RoleinstallationDataSource()
        {
        ...
        [SetterProperty]
        public IScriptGeneratorService<Roleinstallation> Service { get; set; }

        public virtual IEnumerable<Roleinstallation> SelectAll(
            string filterExpression, string startDate, string endDate, string sortExpression, int startRowIndex, int maximumRows)
        {
            ...
            IQueryable<Roleinstallation> queryable;

            IEnumerable<Roleinstallation> logs;
