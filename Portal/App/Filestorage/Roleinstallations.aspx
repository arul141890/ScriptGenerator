<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="Roleinstallations.aspx.cs" Inherits="Portal.App.Filestorage.Roleinstallations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/Filestorage/AddRoleinstallation.aspx") %>">Install File and Storage Role</a>
            </li>
        </ul>
    </div>
    <div>
