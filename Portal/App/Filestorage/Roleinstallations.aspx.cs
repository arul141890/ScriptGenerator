...
{
    public partial class Roleinstallations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(RoleinstallationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Roleinstallation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Filestorage/AddRoleinstallation.aspx?vscId={0}";
