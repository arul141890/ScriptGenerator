<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="Namespacecreations.aspx.cs" Inherits="Portal.App.Filestorage.Namespacecreations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/Filestorage/AddNamespacecreation.aspx") %>">Create New DFS Namespace</a>
            </li>
        </ul>
    </div>
    <div>
