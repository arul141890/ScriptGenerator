<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="Smbsharecreations.aspx.cs" Inherits="Portal.App.Filestorage.Smbsharecreations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="s-breadcrumb">
        <ul>
            ...
            <li>
                <a class="command" href="<%= this.ResolveClientUrl("~/App/Filestorage/AddSmbsharecreation.aspx") %>">Create New SMB Share</a>
            </li>
        </ul>
    </div>
    <div>
