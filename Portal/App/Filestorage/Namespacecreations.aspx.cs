...
{
    public partial class Namespacecreations : BasePage
    {
        public IUserService ClientUserService { get; set; }
        protected void Page_Init(object sender, EventArgs e)
        {
            this.dsData.TypeName = typeof(NamespacecreationDataSource).FullName;
            this.dsData.DataObjectTypeName = typeof(Namespacecreation).FullName;
            ...
            this.gvData.EditButtonUrlFormatString = "/App/Filestorage/AddNamespacecreation.aspx?vscId={0}";
